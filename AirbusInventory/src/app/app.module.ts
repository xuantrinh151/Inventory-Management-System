...
import {UpdateCategoryComponent} from "./update-category/update-product.component";
...
const routes: Routes=[
  ...
  {
    path:'getAllCategories',//path is http:localhost:4200/getAllCategories
  ...
  {
    path:'addCategory',//path is http:localhost:4200/addCategory
  ...
  {
    path:'updateCategory',//path is http:localhost:4200/update
...
@NgModule({
  ...
  providers: [ProductService,AuthenticationServiceService,RouterService,CategoryService],
